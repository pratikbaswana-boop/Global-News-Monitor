...
export const FEED_REGISTRY_SEED: InsertFeedRegistry[] = [
  ...
  // ─── Tier-1: Working alternatives added June 2026 ────────────────────────
  {
  ...
  },
  {
    ...
    url: "https://www.occrp.org/en/investigations?format=feed&type=rss",
    type: "rss",
    credibilityTier: 2,
    isStateMedia: false,
    fetchIntervalSeconds: 1800,
  ...
  // ─── Tier-2: India Business & Energy (confirmed working) ────────────────
  {
    id: "indiatoday-economy",
  ...
  {
    id: "hindu-bl-commodities",
    name: "Hindu BusinessLine Commodities",
  ...
  // ─── Crypto News Sources (for crypto trading module) ────────────────────────
  // These feeds power the news intelligence pipeline for crypto signals.
  // The existing ingestion → embedding → ChromaDB → GPT-4o pipeline processes
  // these identically to NSE news — only the keyword matching differs.
  {
    id: "coindesk",
    name: "CoinDesk",
